 ...
 * @author Myrle Krantz
 */
public class ChangeTaskDefinitionCommand {
  private final String productIdentifier;
  private final TaskDefinition instance;

  public ChangeTaskDefinitionCommand(final String productIdentifier, final TaskDefinition instance) {
