 ...
 * @author Myrle Krantz
 */
public class DeleteProductChargeDefinitionCommand {
  private final String productIdentifier;
  private final String chargeDefinitionIdentifier;

  public DeleteProductChargeDefinitionCommand(final String productIdentifier, final String chargeDefinitionIdentifier) {
