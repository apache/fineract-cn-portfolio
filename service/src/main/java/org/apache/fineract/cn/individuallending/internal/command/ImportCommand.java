...
public class ImportCommand {
  ...
  public ImportCommand(final String productIdentifier, final String caseIdentifier, final ImportParameters importParameters) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productIdentifier, caseIdentifier, importParameters);
  }
